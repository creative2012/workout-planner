        ...
        >
          ...
          >
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.shoulders
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.shoulders}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.waist
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.waist}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.tummy
                  ? "active"
                  : "inactive"
              }`}
            >
              ...
              />
              <path
                className={muscleGroupNames.tummy}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.lowerarms
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.lowerarms}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.upperlegs
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.upperlegs}
        ...
        >
          ...
          >
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back1
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back1}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back2
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back2}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back3
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back3}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back4
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back4}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back5
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back5}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back6
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back6}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back7
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back7}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back8
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back8}
            ...
            <g
              onClick={clickedMuscleGroup}
              className={`muscle_group ${
                muscleGroups.primary === muscleGroupNames.back9
                  ? "active"
                  : "inactive"
              }`}
            >
              <path
                className={muscleGroupNames.back9}
